...
-- Schema hclcapstone
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `hclcapstone`;

CREATE SCHEMA `hclcapstone`;
USE `hclcapstone` ;

-- -----------------------------------------------------
-- Table `hclcapstone`.`product_category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hclcapstone`.`product_category` (
...
-- -----------------------------------------------------
-- Table `hclcapstone`.`product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hclcapstone`.`product` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
