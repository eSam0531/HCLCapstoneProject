...
export class ProductListComponent implements OnInit {
  ...
  handleListProducts() {
    ...
    if (hasCategoryId) {
      // get the "id" param string. convert sting to a number using the "+" symbol
      this.currentCategoryId = +this.route.snapshot.paramMap.get("id");
    }
    else {
      //no category id avaialbe... default to category id 1
    ...
    // arg thePageNumber is being decremented since Spring Data REST pages are 0 based and
    // pagination component in Angulare is 1 based.
